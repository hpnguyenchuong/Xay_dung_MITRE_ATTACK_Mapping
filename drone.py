            ...
            try:
                if endpoint == "attacks":
                    ...
                    if drone_id:
                        ...
                        title = f"AERO-SHIELD Analysis - Drone {drone_id}"
                    else:
                        cursor.execute("SELECT technique_id, MAX(confidence) as conf, COUNT(*) as occ, MAX(name) as name FROM attack_mapping WHERE technique_id IS NOT NULL GROUP BY technique_id")
                        title = "AERO-SHIELD DroneFleet Analysis (All Drones)"
                    ...
                    nav = {
                        ...
                        "versions": { "attack": "14", "navigator": "4.9.1", "layer": "4.5" },
                        "domain": "ics-attack",
                        "description": "Auto-generated by AERO-SHIELD SOC OS based on actual drone telemetry and events.",
                        "gradient": {
                    ...
                    for row in techs_data:
                        ...
                        if row["name"]:
                            comment += f" | Mapped rule: {row['name']}"
                    ...
                    prefix = f"navigator_{drone_id}_" if drone_id else "navigator_all_"
